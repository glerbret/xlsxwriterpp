...
int main()
{
  ...
  const xwpp::chart_font_t font2{.name_ = "Courier", .color_ = static_cast<xwpp::color_t>(0x92D050)};
  const xwpp::chart_font_t font3{.name_ = "Arial", .color_ = static_cast<xwpp::color_t>(0x00B0F0)};
  const xwpp::chart_font_t font4{.name_ = "Century", .color_ = xwpp::color_t::RED};
  const xwpp::chart_font_t font5{.rotation_ = -30};
  const xwpp::chart_font_t font6{
