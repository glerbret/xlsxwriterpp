...
int main()
{
  ...
  chart.set_axis_ids(45642496, 45644416);
  ...
  xwpp::chart_axis_set_line(chart.y_axis_, line);
  xwpp::chart_axis_set_fill(chart.y_axis_, fill);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_axis38.xlsx");
}
