...
int main()
{
  ...
  chart.set_axis_ids(67858816, 67863296);
  ...
  const std::vector<xwpp::chart_data_label_t> data_labels{{.hide_ = true}, {}, {.hide_ = true}, {}, {.hide_ = true}};
  ...
  workbook.save("test_chart_data_labels30.xlsx");
}
