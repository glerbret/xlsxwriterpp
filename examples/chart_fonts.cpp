...
int main()
{
  ...
  const xwpp::chart_font_t font1{.name_ = "Calibri", .color_ = xwpp::color_t::blue()};
  const xwpp::chart_font_t font2{.name_ = "Courier", .color_ = xwpp::color_t{0x92D050}};
  const xwpp::chart_font_t font3{.name_ = "Arial", .color_ = xwpp::color_t{0x00B0F0}};
  const xwpp::chart_font_t font4{.name_ = "Century", .color_ = xwpp::color_t::red()};
  const xwpp::chart_font_t font5{.rotation_ = -30};
  const xwpp::chart_font_t font6{.bold_ = true, .italic_ = true, .underline_ = true, .color_ = xwpp::color_t{0x7030A0}};
