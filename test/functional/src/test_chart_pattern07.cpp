...
int main()
{
  ...
  xwpp::chart_pattern_t pattern1 = {.fg_color_ = xwpp::color_t(0xC00000),
                                    ...
                                    .type_     = xwpp::chart_pattern_type_t::PERCENT_40};
  xwpp::chart_pattern_t pattern2 = {.fg_color_ = xwpp::color_t(0xFF0000),
                                    .type_     = xwpp::chart_pattern_type_t::PERCENT_90};
  xwpp::chart_pattern_t pattern3 = {.fg_color_ = xwpp::color_t(0xFFC000),
                                    .type_     = xwpp::chart_pattern_type_t::WIDE_UPWARD_DIAGONAL};
  xwpp::chart_pattern_t pattern4 = {.fg_color_ = xwpp::color_t(0xFFFF00),
                                    .type_     = xwpp::chart_pattern_type_t::DARK_HORIZONTAL};
  xwpp::chart_pattern_t pattern5 = {.fg_color_ = xwpp::color_t(0x92D050),
                                    .type_     = xwpp::chart_pattern_type_t::LARGE_CONFETTI};
  xwpp::chart_pattern_t pattern6 = {.fg_color_ = xwpp::color_t(0x00B050), .type_ = xwpp::chart_pattern_type_t::PLAID};
  xwpp::chart_pattern_t pattern7 = {.fg_color_ = xwpp::color_t(0x00B0F0), .type_ = xwpp::chart_pattern_type_t::SPHERE};
  xwpp::chart_pattern_t pattern8 = {.fg_color_ = xwpp::color_t(0x0070C0),
                                    .type_     = xwpp::chart_pattern_type_t::SOLID_DIAMOND};
  ...
  workbook.save("test_chart_pattern07.xlsx");
}
