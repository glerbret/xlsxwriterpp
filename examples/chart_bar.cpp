/*
 * An example of creating Excel bar charts using the Xlsxwriter++ library.
 *
...
int main()
{
  ...
  // TODO Create chart outside workbook and calling API insert_chart directly with the chart (note: add chart ctor for
  // convenience)
  xwpp::chart_t& chart1 = workbook.add_chart(xwpp::chart_type_t::BAR);

  // Add the first series to the chart.
  // TODO Two API
  // - One with parameters to build series (including name): create the series and doesn't return anything
  // - One with a prebuild series
  ...
  xwpp::chart_t& chart2 = workbook.add_chart(xwpp::chart_type_t::BAR_STACKED);
  ...
  xwpp::chart_t& chart3 = workbook.add_chart(xwpp::chart_type_t::BAR_STACKED_PERCENT);
