...
[[nodiscard]] std::string write_move_with_cells()
{
  return xml_empty_tag("x:MoveWithCells");
}

[[nodiscard]] std::string write_size_with_cells()
{
...
[[nodiscard]] std::string write_text_halign()
{
  return xml_data_element("x:TextHAlign", "Center");
}

[[nodiscard]] std::string write_text_valign()
{
  return xml_data_element("x:TextVAlign", "Center");
}

[[nodiscard]] std::string write_fmla_macro(const vml_obj_t& vml_obj)
{
...
[[nodiscard]] std::string write_formulas()
{
