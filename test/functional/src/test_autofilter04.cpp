...
int main()
{
  ...
  const xwpp::filter_rule_t filter_rule2{.criteria_ = xwpp::filter_criteria_t::GREATER_THAN, .value_ = 3000};
  const xwpp::filter_rule_t filter_rule3{.criteria_ = xwpp::filter_criteria_t::LESS_THAN, .value_ = 8000};
