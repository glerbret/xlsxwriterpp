...
int main()
{
  ...
  worksheet.set_column(COLS("F:F"), xwpp::DEF_COL_WIDTH, NULL, col_hidden);

  chart.add_series("", "=Sheet1!$A$2:$A$6");
  chart.add_series("", "=Sheet1!$B$2:$B$6");
  chart.add_series("", "=Sheet1!$C$2:$C$6");

  xwpp::chart_options_t chart_options = {.object_position_ = xwpp::object_position_t::MOVE_DONT_SIZE};
