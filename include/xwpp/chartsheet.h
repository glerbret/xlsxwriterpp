 ...
 * chartsheet.h.
 */
// TODO Add a common parent class to chartsheet_t and worksheet_t instead of embedded worksheet_t
// to hold common part
// Alternative is to use a third class with no hierarchy relationship as data member
class chartsheet_t
{
public:
