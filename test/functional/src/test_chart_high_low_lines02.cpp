...
int main()
{
  ...
  chart.set_axis_ids(61180928, 63898368);
  ...
  xwpp::chart_line_t line = {.color_ = xwpp::color_t::RED, .dash_type_ = xwpp::chart_line_dash_type_t::DASH_SQUARE_DOT};
  ...
  workbook.save("test_chart_high_low_lines02.xlsx");
}
