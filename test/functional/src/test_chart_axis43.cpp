...
int main()
{
  ...
  chart.set_axis_ids(61296640, 61298560);
  ...
  xwpp::chart_axis_set_label_align(chart.x_axis_, xwpp::chart_axis_label_alignment_t::LEFT);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_axis43.xlsx");
}
