...
int main()
{
  ...
  chart.set_axis_ids(45705472, 54518528);
  ...
  xwpp::chart_axis_set_min(chart.x_axis_, 0);
  xwpp::chart_axis_set_max(chart.x_axis_, 20);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_axis11.xlsx");
}
