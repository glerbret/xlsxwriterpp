...
int main()
{
  ...
  chart.set_axis_ids(82812288, 46261376);
  ...
  chart_axis_major_gridlines_set_visible(chart.x_axis_, true);
  chart_axis_minor_gridlines_set_visible(chart.x_axis_, true);
  ...
  workbook.save("test_chart_gridlines06.xlsx");
}
