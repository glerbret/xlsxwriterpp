...
int main()
{
  ...
  chart.set_axis_ids(49016832, 49019136);
  ...
  chart.series_set_error_bars(series1.x_error_bars_, xwpp::chart_error_bar_type_t::STD_ERROR, 0);
  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_errorbars05.xlsx");
}
