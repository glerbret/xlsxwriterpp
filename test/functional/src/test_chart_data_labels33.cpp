...
int main()
{
  ...
  xwpp::chart_font_t font1                          = {.bold_ = true, .italic_ = true, .baseline_ = -1};
  std::vector<xwpp::chart_data_label_t> data_labels = {{.font_ = font1}};
  ...
  workbook.save("test_chart_data_labels33.xlsx");
}
