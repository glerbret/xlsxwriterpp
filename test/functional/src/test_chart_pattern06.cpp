...
int main()
{
  ...
  xwpp::chart_pattern_t pattern6 = {.fg_color_ = xwpp::color_t(0x00B050), .type_ = xwpp::chart_pattern_type_t::WEAVE};
  xwpp::chart_pattern_t pattern7 = {.fg_color_ = xwpp::color_t(0x00B0F0), .type_ = xwpp::chart_pattern_type_t::TRELLIS};
