...
int main()
{
  ...
  chart.set_axis_ids(69200896, 69215360);
  ...
  xwpp::chart_axis_set_position(chart.x_axis_, xwpp::chart_axis_tick_position_t::ON_TICK);
  ...
  workbook.save("test_chart_axis30.xlsx");
}
