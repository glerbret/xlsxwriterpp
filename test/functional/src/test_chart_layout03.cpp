...
int main()
{
  ...
  chart.set_axis_ids(68312064, 69198592);
  ...
  const xwpp::chart_layout_t layout{
    .x_      = 0.80197353455818,
    .y_      = 0.37442403032954,
    .width_  = 0.12858202099737,
    .height_ = 0.25115157480314,
  };

  chart.legend_set_layout(layout);
  chart.legend_set_position(xwpp::chart_legend_position_t::OVERLAY_RIGHT);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_layout03.xlsx");
}
