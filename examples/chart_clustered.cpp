...
{
  worksheet.write(0, 0, "Types", bold);
  worksheet.write(1, 0, "Type 1");
  worksheet.write(4, 0, "Type 2");

  worksheet.write(0, 1, "Sub Type", bold);
  ...
  worksheet.write(0, 2, "Value 1", bold);
  ...
  worksheet.write(0, 3, "Value 2", bold);
  ...
  worksheet.write(0, 4, "Value 3", bold);
