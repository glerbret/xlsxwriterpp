...
void write_worksheet_data(xwpp::worksheet_t& worksheet, const xwpp::format_t* header)
{
  ...
  worksheet.write(CELL("A1"), "Region", header);
  worksheet.write(CELL("B1"), "Sales Rep", header);
  worksheet.write(CELL("C1"), "Product", header);
  worksheet.write(CELL("D1"), "Units", header);
...
int main()
{
  ...
  // Example of using the FILTER() function.
  {
    ...
    worksheet.write(CELL("K1"), "Product", header2);
    worksheet.write(CELL("K2"), "Apple");
    worksheet.write(CELL("F1"), "Region", header2);
    worksheet.write(CELL("G1"), "Sales Rep", header2);
    worksheet.write(CELL("H1"), "Product", header2);
  ...
  // Example of using the UNIQUE() function.
  {
    ...
    // Write the data the function will work on.
    worksheet.write(CELL("F1"), "Sales Rep", header2);
  ...
  // Example of using the SORTBY() function.
  {
    ...
    // Write the data the function will work on.
    worksheet.write(CELL("A1"), "Name", header1);
    worksheet.write(CELL("B1"), "Age", header1);

    worksheet.write(CELL("A2"), "Tom");
    worksheet.write(CELL("A3"), "Fred");
    worksheet.write(CELL("A4"), "Amy");
    worksheet.write(CELL("A5"), "Sal");
    worksheet.write(CELL("A6"), "Fritz");
    worksheet.write(CELL("A7"), "Srivan");
    worksheet.write(CELL("A8"), "Xi");
    worksheet.write(CELL("A9"), "Hector");

    worksheet.write(CELL("B2"), 52);
    worksheet.write(CELL("B3"), 65);
    worksheet.write(CELL("B4"), 22);
    worksheet.write(CELL("B5"), 73);
    worksheet.write(CELL("B6"), 19);
    worksheet.write(CELL("B7"), 39);
    worksheet.write(CELL("B8"), 19);
    worksheet.write(CELL("B9"), 66);
  ...
  // Example of using the XLOOKUP() function.
  {
    ...
    // Write the data the function will work on.
    worksheet.write(CELL("A1"), "Country", header1);
    worksheet.write(CELL("B1"), "Abr", header1);
    worksheet.write(CELL("C1"), "Prefix", header1);

    worksheet.write(CELL("A2"), "China");
    worksheet.write(CELL("A3"), "India");
    worksheet.write(CELL("A4"), "United States");
    worksheet.write(CELL("A5"), "Indonesia");
    worksheet.write(CELL("A6"), "Brazil");
    worksheet.write(CELL("A7"), "Pakistan");
    worksheet.write(CELL("A8"), "Nigeria");
    worksheet.write(CELL("A9"), "Bangladesh");

    worksheet.write(CELL("B2"), "CN");
    worksheet.write(CELL("B3"), "IN");
    worksheet.write(CELL("B4"), "US");
    worksheet.write(CELL("B5"), "ID");
    worksheet.write(CELL("B6"), "BR");
    worksheet.write(CELL("B7"), "PK");
    worksheet.write(CELL("B8"), "NG");
    worksheet.write(CELL("B9"), "BD");

    worksheet.write(CELL("C2"), 86);
    worksheet.write(CELL("C3"), 91);
    worksheet.write(CELL("C4"), 1);
    worksheet.write(CELL("C5"), 62);
    worksheet.write(CELL("C6"), 55);
    worksheet.write(CELL("C7"), 92);
    worksheet.write(CELL("C8"), 234);
    worksheet.write(CELL("C9"), 880);
  ...
  // Example of using the XMATCH() function.
  {
    ...
    // Write the data the function will work on.
    worksheet.write(CELL("A1"), "Product", header1);

    worksheet.write(CELL("A2"), "Apple");
    worksheet.write(CELL("A3"), "Grape");
    worksheet.write(CELL("A4"), "Pear");
    worksheet.write(CELL("A5"), "Banana");
    worksheet.write(CELL("A6"), "Cherry");

    worksheet.write(CELL("C1"), "Product", header2);
  ...
  // Example of using the Spill range operator.
  {
    ...
    worksheet.write(CELL("F1"), "Unique", header2);
    worksheet.write(CELL("H1"), "Spill", header2);
  ...
  // Example of using dynamic ranges with older Excel functions.
  {
    ...
    worksheet.write(CELL("A2"), "Food");
    worksheet.write(CELL("A3"), "Frood");
  }
