...
int main()
{
  ...
  xwpp::row_col_options_t options4 = {.hidden_ = true, .level_ = 1, .collapsed_ = true};
  ...
  worksheet.set_row(1, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(2, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(3, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(4, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(5, xwpp::DEF_ROW_HEIGHT, nullptr, options4);

  worksheet.set_row(6, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(7, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(8, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(9, xwpp::DEF_ROW_HEIGHT, nullptr, options3);
  worksheet.set_row(10, xwpp::DEF_ROW_HEIGHT, nullptr, options4);
  worksheet.set_row(11, xwpp::DEF_ROW_HEIGHT, nullptr, options5);
  ...
  workbook.save("test_outline05.xlsx");
}
