...
int main()
{
  ...
  worksheet.add_table("F3:G33", options2);

  xwpp::table_options_t options3{.name_ = "Table["};
  worksheet.add_table("F3:G33", options3);
  ...
  worksheet.add_table("F3:G33", options4);

  xwpp::table_options_t options5{.name_ = "c"};
  worksheet.add_table("F3:G33", options5);

  xwpp::table_options_t options6{.name_ = "R"};
  worksheet.add_table("F3:G33", options6);

  xwpp::table_options_t options7{.name_ = ".Table"};
  worksheet.add_table("F3:G33", options7);

  xwpp::table_options_t options8{.name_ = "1Table"};
  worksheet.add_table("F3:G33", options8);
*/
