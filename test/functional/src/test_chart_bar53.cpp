...
int main()
{
  ...
  xwpp::chart_add_data_cache(series3.categories_, data[0], 4, 3, 0);
  xwpp::chart_add_data_cache(series4.categories_, data[0], 4, 3, 0);
  xwpp::chart_add_data_cache(series3.values_, data[0], 4, 3, 1);
  xwpp::chart_add_data_cache(series4.values_, data[0], 4, 3, 2);
