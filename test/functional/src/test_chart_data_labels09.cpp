...
int main()
{
  ...
  xwpp::chart_series_set_labels_position(series1, xwpp::chart_label_position_t::ABOVE);
  xwpp::chart_series_set_labels_position(series2, xwpp::chart_label_position_t::BELOW);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_data_labels09.xlsx");
}
