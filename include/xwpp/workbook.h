...
public:
  ...
  [[nodiscard]] worksheet_t& get_worksheet_by_name(std::string_view name);
  [[nodiscard]] bool is_worksheet_present(std::string_view name) const;
  ...
  /// @brief Non-const overload
  [[nodiscard]] chartsheet_t& get_chartsheet_by_name(std::string_view name);
  [[nodiscard]] bool is_chartsheet_present(std::string_view name) const;
