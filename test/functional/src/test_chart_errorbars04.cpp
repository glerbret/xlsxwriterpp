...
int main()
{
  ...
  chart.set_axis_ids(61626624, 69664128);
  ...
  chart.series_set_error_bars(series1.x_error_bars_, xwpp::chart_error_bar_type_t::STD_DEV, 1);
  chart.series_set_error_bars(series1.y_error_bars_, xwpp::chart_error_bar_type_t::STD_ERROR, 0);

  worksheet.insert_chart(CELL("E9"), &chart);

  workbook.save("test_chart_errorbars04.xlsx");
}
